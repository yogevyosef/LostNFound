...
<body>
    ...
    <div class="main">
        <form action="ItemFound" method="POST">
            <h1 style="font-size: 35px; margin: 0px;">Found Form</h1>
            <p><b>Please fill in this form to post a found.</b></p>
            <hr>

            <fieldset>
                <legend>Time & Position</legend>

                <label for="dateNtime">Please select the date and time of the found</label><br><br>
                ...
                <label for="city">Please enter the city you found the found</label>
                ...
                <label for="street">Please enter the street you found the found</label>
                <input type="text" placeholder="Enter Street" id="street" name="street" e title="Required field" required
            ...
            <fieldset>
                ...
                <label for="category">Please enter the object of the found</label><br><br>
                ...
                <label for="color">Please enter the color of the found</label>
