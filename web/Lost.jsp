...
<body>
    ...
    <div class="main">
        ...
        <table id="LostTable">
            <thead>
            <th style="font-size: 20px;text-align: center">Lost serial number</th>
            ...
            <%
                Vector<FoundLostItem> lost = ItemInterface.getAllLost();
                //removing all the lost that has a match
                for (Iterator<FoundLostItem> iterator = lost.iterator(); iterator.hasNext(); ) {
                    FoundLostItem tempLost = iterator.next();
                    if (MatchInterface.isApproved(tempLost.getSerial()))
                        iterator.remove();
                }
                ...
                {%>
            <tr>
                <td><%=lost.elementAt(i).getSerial()%></td>
                <td><%=lost.elementAt(i).getItem().getCategory()%></td>
                <td><%=lost.elementAt(i).getAddress().getCity()%></td>
                <td><%=lost.elementAt(i).getFoundLostDate().toLocalDate().toString()%></td>
            </tr>
            <%}%>
        </table>
    ...
    <script>
        ...
        function searchFunc() {
            ...
            table = document.getElementById("LostTable");
